...
public class PantallaPuntajes implements State {
	...
	public PantallaPuntajes(UserInterface UI) {
		miUI=UI;
		...
		lblPosicion.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblPosicion.setBounds(20, 51, 144, 50);
		panel.add(lblPosicion);
		
		JLabel lblJugador = new JLabel("Jugador");
		lblJugador.setHorizontalAlignment(SwingConstants.CENTER);
		lblJugador.setForeground(Color.WHITE);
		lblJugador.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblJugador.setBounds(174, 51, 215, 50);
		...
		lblPosicion_1_1.setFont(new Font("Tahoma", Font.PLAIN, 24));
		...
		lblPosicion_1.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPosicion_2.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPosicion_3.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPosicion_4.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPosicion_5.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPosicion_6.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPosicion_7.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblJugador_7.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblJugador_2.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblJugador_3.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblJugador_4.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblJugador_5.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblJugador_6.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_7.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_1.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_2.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_3.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_4.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_5.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblPuntos_6.setFont(new Font("Tahoma", Font.PLAIN, 22));
		...
		lblApreteEspacioPara.setFont(new Font("Tahoma", Font.BOLD, 16));
	...
	public void seApretoEspacio() {
		State estadoNuevo=new MenuPrincipal(miUI ,2);
